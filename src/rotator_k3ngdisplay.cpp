...
#endif
#if defined(FEATURE_YOURDUINO_I2C_LCD) || defined(FEATURE_RFROBOT_I2C_DISPLAY) || defined(FEATURE_SAINSMART_I2C_LCD) || defined(FEATURE_SUNFOUNDER_I2C_LCD)
...
#if defined(FEATURE_SUNFOUNDER_I2C_LCD)
  LiquidCrystal_I2C lcd(0x27,20,4);
#endif //FEATURE_SUNFOUNDER_I2C_LCD
